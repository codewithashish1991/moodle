...
class __Mustache_3795973aae9e45f2bafa5ca8d373e917 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <div class="bg-pulse-grey card-img dashboard-list-img w-100" style="height: 1rem; width: 1rem;"></div>
';
        $buffer .= $indent . '        </div>
';
